...
router.get('/alerts', requirePermission('online_store.view'), controller.alerts);
router.put('/alerts/:id/read', requirePermission('online_store.view'), controller.readAlert);
